...
const Foodcard = (prop) => {
  return (
        <div className='md:w-3/5 w-1/3 text-sm md:text-md mx-auto '>
...
const Deal = () => {
  ...
  return (
    <div className='relative bg-black text-white p-12 text-center border border-black z-20'>
      ...
      <div className=' bg-white  mx-auto pt-24 pb-16 w-5/6 md:w-11/12 absolute -bottom-1/2 -translate-y-1/3 border-t-8 rounded-lg border-green-500 shadow-xl'>
        <div className='relative'>
          <div className='md:-translate-y-2/3 lg:-translate-y-1/2 gap-y-8 grid grid-cols-2 md:grid-cols-4 text-sm md:text-md md:grid-cols-4 bg-green-500 p-4 px-8 md:px-12 absolute -top-1/2 left-1/2 -translate-y-1/4 -translate-x-1/2 xl:-translate-y-1/4 rounded-full text-white w-max mx-auto'>
